        ...
        <div class="flex justify-between h-16">
                        ...
                        @if (Auth::user()->hasVerifiedEmail())
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                @foreach ($user_links as $link )
                                    <x-nav-link href="{{ $link['route'] }}" :active="$link['active']">{{ $link['name'] }}</x-nav-link>
                                @endforeach
                            </div>
                        @endif
                    @endauth
            ...
            @auth
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <!-- Teams Dropdown -->
                    @if (Laravel\Jetstream\Jetstream::hasTeamFeatures() && \Auth::user()->currentTeam && \Auth::user()->hasVerifiedEmail())
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if (Auth::user()->hasVerifiedEmail())
                    <div class="pt-2 pb-3 space-y-1">
                        @foreach ($user_links as $link)
                            <x-responsive-nav-link href="{{ $link['route'] }}" :active="$link['active']">{{ $link['name'] }}</x-responsive-nav-link>
                        @endforeach
                    </div>
                @endif
            @endauth
